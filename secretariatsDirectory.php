<?php 
    ...
    $tableName = 'Secretariats Directory';
    $pageName = 'secretariatsDirectory.php';
?>
<?php
...
<head>
    ...
    <title><?php echo TITLE; ?> - Secretariats Directory</title>
    <!-- Custom CSS -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    $sql = "SELECT * FROM `". $tableName ."` order by `sid`";
                                    // echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
