...
<head>
    ...
    <title><?php echo TITLE; ?> - Other Forms</title>
    ...
    <!-- ============================================================== -->
      ...
      <header class="topbar" data-navbarbg="skin6">
        ...
        <div class="page-wrapper">
              ...
              <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Other Forms</h3>
          ...
          echo' <div class="card">
                            <div class="card-body">
                            <form action="otherforms.php" method="post" enctype="multipart/form-data">  
                              <div class="btn-list">
                                Select File:  
