<?php 
    ...
    $tableName = 'Health card data';
    $pageName = 'healthCards.php';
?>
<?php
  ...
  if(isset($_POST['id']))
  {
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM `" . $tableName . "` WHERE `UHID`=\"$id\"";
...
<head>
    ...
    <title><?php echo TITLE; ?> - Health Cards Data</title>
    <!-- Custom CSS -->
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Health Cards Data
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    $sql = "SELECT * FROM `". $tableName ."` Where `Office` = ". $office . " order by `UHID` ";
                                    // echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
