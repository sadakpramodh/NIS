<?php 
    ...
    $tableName = 'Volunteers Data';
    $pageName = 'volunteerData.php';
?>
<?php
  ...
  if(isset($_POST['id']))
  {
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM `" . $tableName . "` WHERE `vid`=\"$id\"";
...
<head>
    ...
    <title><?php echo TITLE; ?> - Volunteers Data</title>
    <!-- Custom CSS -->
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Volunteers Data
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    $sql = "SELECT * FROM `". $tableName ."` Where `Secretariat Code` = ". $office . " order by `vid` ";
                                    // echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
