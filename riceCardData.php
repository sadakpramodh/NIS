<?php 
    ...
    $tableName = 'Civil Supplies Data';
    $pageName = 'riceCardData.php';
?>
<?php
  ...
  if(isset($_POST['id']))
  {
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM `" . $tableName . "` WHERE `rid`=\"$id\"";
...
<head>
    ...
    <title><?php echo TITLE; ?> - RiceCard Data</title>
    <!-- Custom CSS -->
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Rice Card Data
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    {
                                      $x = ' AND `Cluster` = "' . $_SESSION['cluster'] .'"';
                                    }
                                    $sql = "SELECT * FROM `". $tableName ."` Where `Secretariat Code` = ". $office . $x . " order by `rid` ";
//                                     echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
