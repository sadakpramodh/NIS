<?php 
    ...
    $tableName = 'Secretaries Data';
    $pageName = 'secretariesData.php';
?>
<?php
  ...
  if(isset($_POST['id']))
  {
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM `" . $tableName . "` WHERE `sid`=\"$id\"";
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">Secretaries Data
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    $sql = "SELECT * FROM `". $tableName ."` Where `Office` = ". $office . " order by `sid` ";
                                    // echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
