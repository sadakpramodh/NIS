...
<head>
    ...
    <title><?php echo TITLE; ?> - GO's and Others</title>
    ...
    <!-- ============================================================== -->
      ...
      <header class="topbar" data-navbarbg="skin6">
        ...
        <div class="page-wrapper">
              ...
              <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">GO's and Others</h3>
          ...
          echo' <div class="card">
                            <div class="card-body">
                            <form action="Go\'sandOthers.php" method="post" enctype="multipart/form-data">  
                              <div class="btn-list">
                                Select File:  
