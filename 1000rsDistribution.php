<?php 
    ...
    $tableName = '1000 rs distribution';
    $pageName = '1000rsDistribution.php';
?>
<?php
  ...
  if(isset($_POST['id']))
  {
    ...
    $id = $_POST['id'];
    $sql = "SELECT * FROM `" . $tableName . "` WHERE `sno`=\"$id\"";
...
<head>
    ...
    <title><?php echo TITLE; ?> - Secretaies Data</title>
    <!-- Custom CSS -->
                        ...
                        <div class="card">
                            <div class="card-body">
                              ...
                              <?php 
                                    ...
                                    $sql = "SELECT * FROM `". $tableName ."` Where `Office` = ". $office . $x . " order by `sno` ";
//                                     echo $sql;
                                    $query = $connection->prepare($sql);
                                    $query->execute();
                                    // Use fetchAll as you have
